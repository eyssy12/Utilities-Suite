namespace File.Organiser.UI.Controls
{
    ...
    public static class ContentControlBehaviour
    {
        public static readonly DependencyProperty ContentChangedAnimationProperty = DependencyProperty.RegisterAttached(
            "ContentChangedAnimation", 
            typeof(Storyboard),
            typeof(ContentControlBehaviour),
            new PropertyMetadata(default(Storyboard), ContentControlBehaviour.ContentChangedAnimationPropertyChangedCallback));
